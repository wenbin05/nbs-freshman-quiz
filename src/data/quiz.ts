    ...
    options: [
      {
        ...
        weights: { overachiever: 5, lowkeyStrategist: 1 },
      ...
      },
      {
        ...
        weights: { lostButVibing: 5, weBallAgent: 1 },
      ...
      },
      {
        ...
        weights: { softSupporter: 5, lostButVibing: 1 },
      ...
      },
      {
        ...
        weights: { weBallAgent: 5, lostButVibing: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        weights: { socialButterfly: 4, softSupporter: 2 },
      ...
      },
      {
        ...
        weights: { softSupporter: 4, socialButterfly: 2 },
        primaryOutcome: "softSupporter",
      },
      {
        id: "D",
        ...
        weights: { lostButVibing: 4, softSupporter: 2 },
        primaryOutcome: "lostButVibing",
      },
    ],
  },
    ...
    options: [
      {
        ...
        weights: { overachiever: 4, lowkeyStrategist: 2 },
        primaryOutcome: "overachiever",
      },
      {
        id: "B",
        ...
        weights: { lowkeyStrategist: 5, socialButterfly: 1 },
        primaryOutcome: "lowkeyStrategist",
      },
      {
        id: "C",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        weights: { lowkeyStrategist: 4, softSupporter: 2 },
        primaryOutcome: "lowkeyStrategist",
      },
      {
        id: "D",
        ...
        weights: { weBallAgent: 5, socialButterfly: 1 },
        primaryOutcome: "weBallAgent",
      },
    ],
  },
    ...
    options: [
      {
        ...
        weights: { lowkeyStrategist: 5, overachiever: 1 },
        primaryOutcome: "lowkeyStrategist",
      },
      {
        id: "B",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        weights: { lowkeyStrategist: 5, softSupporter: 1 },
        primaryOutcome: "lowkeyStrategist",
      },
      {
        id: "D",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        weights: { socialButterfly: 5, lostButVibing: 1 },
        primaryOutcome: "socialButterfly",
      },
      {
        id: "C",
      ...
      },
      {
        ...
        weights: { weBallAgent: 4, lostButVibing: 2 },
        primaryOutcome: "weBallAgent",
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        weights: { lostButVibing: 4, overachiever: 2 },
        primaryOutcome: "lostButVibing",
      },
    ],
  },
